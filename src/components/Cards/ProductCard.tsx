...
const ProductCard: FC<{
  ...
  return (
    <div
      className="flex flex-col w-[300px] group sm:w-[97%] sm:flex-row sm:justify-between justify-center items-center sm:items-start bg-white   m-5  gap-10 p-5 drop-shadow-2xl rounded-xl animate-slideup hover:bg-[#ffe3d1]"
    ...
    >
      ...
      <div className="flex flex-1 flex-col  ">
        ...
        <div className="flex items-center justify-start gap-4 mb-2 ">
          <Rating rating={props.rating} clasName="group-hover:text-gray-500" />
